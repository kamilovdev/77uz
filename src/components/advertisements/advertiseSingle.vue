...
<template>
  <div class="containerMain flex flex-col gap-6 max-sm:px-0">
    ...
    <div class="flex gap-4 px-3">
      <router-link to="/" class="text-[14px] text-[#16191D] font-medium"
        >Главная</router-link
      >
      <router-link to="" class="text-[14px] text-[#16191D] font-medium"
        >Электроника</router-link
      >
      <router-link class="text-[14px] text-[#16191D] font-medium"
        >Фены</router-link
      >
      <router-link class="text-[14px] text-[#B8BBBD] font-medium"
        >457 147</router-link
      >
    </div>
    ...
    <div class="flex gap-6 max-sm:flex-col">
      <div class="w-[882px] flex flex-col gap-4">
        <div
          class="relative bg-white w-full px-6 py-6 rounded-lg flex flex-col gap-5 max-sm:w-[375px] max-sm:px-4 max-sm:py-4"
        >
          <div
          ...
          >
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img
                  :src="product.image"
                  class="d-block w-full h-[481px] rounded-xl object-cover max-sm:w-[343px]"
                  alt="..."
                />
              </div>
          ...
          <div class="flex gap-3">
            ...
            >
              <button
                class="border-4 border-transparent focus:border-blue-500 rounded-xl"
              >
                <img
                  class="w-[110px] h-[64px] object-cover rounded-lg"
                  :src="img"
                  alt=""
                />
              </button>
          ...
          <div class="flex flex-col gap-6">
            <div class="flex flex-col gap-2">
              <span class="flex gap-5">
                <p
                  class="cursor-pointer text-[14px] font-normal text-[#8E9297]"
                >
                  Электроника
                </p>
                <p
              ...
              <h1
                class="text-[20px] font-bold text-[#16191D] max-sm:text-[16px]"
              >
                {{ product.title }}
              </h1>
            ...
            <div
              class="flex justify-between items-center max-sm:flex-col max-sm:items-start max-sm:gap-4"
            >
              <span class="flex gap-2">
                <h1
                  class="text-[24px] font-bold text-[#16191D] max-sm:text-[24px]"
                >
                  {{ product.price }}
                </h1>
                <p
                  class="text-[16px] text-[#388FF3] font-medium pt-[6px] max-sm:text-[16px]"
                >
                  {{ product.currency }}
                </p>
              </span>
              <span>
                <button
                  class="bg-[#388FF3] text-white py-[10px] px-[47px] rounded-lg max-sm:px-[93px] max-sm:text-[13px]"
                >
                  <i
                    class="fa-solid fa-phone text-white max-sm:text-[14px]"
                  ></i>
                  {{ product.number }}
                </button>
              </span>
        ...
        <div
          class="bg-white w-full px-6 py-6 rounded-lg flex flex-col gap-5 max-sm:w-[375px] max-sm:!gap-3"
        >
        ...
        <div
          class="bg-white w-full px-6 py-6 rounded-lg flex flex-col gap-5 max-sm:w-[375px] max-sm:!gap-4"
        >
          ...
          <div class="flex justify-between max-sm:flex-col max-sm:gap-4">
            <div class="flex gap-3">
              <img
                class="rounded-md"
                src="../../../public/productSingle/avtor.png"
                alt=""
              />
              <span>
            ...
            <div class="flex gap-4 items-center max-sm:justify-between">
              <h1
                class="text-[16px] font-semibold text-[#16191D] max-sm:text-[14px]"
              >
                {{ product.number }}
              </h1>
              <button
                class="py-[10px] px-6 text-[14px] text-[#16191D] bg-[#EAEDF0] font-semibold rounded-lg max-sm:px-3 max-sm:text-[12px]"
              >
                Показать телефон
              </button>
            </div>
      ...
      <div>
        <div
          class="bg-white w-fit px-3 py-6 rounded-lg flex flex-col gap-5 max-sm:w-[375px] max-sm:!gap-4 max-sm:hidden"
        >
          <div class="flex flex-col gap-3">
            <div class="flex gap-3">
              <img
                class="rounded-md w-10"
                src="../../../public/productSingle/avtor.png"
                alt=""
              />
              <span>
            ...
            <div>
              <h1 class="text-[16px] font-bold text-[#16191D]">
                {{ product.number }}
              </h1>
            </div>
            <button
              class="px-[58px] py-[10px] bg-[#EAEDF0] rounded-lg text-[14px] text-[#16191D] flex gap-2 items-center font-semibold max-sm:px-[91px]"
            >
              Все объявления
            </button>
          </div>
        ...
        <div class="bg-white rounded-lg mt-4 w-[278px] max-sm:w-[375px]">
          ...
          <div class="px-1 py-1">
            <img
              class="rounded-b-lg max-sm:w-[375px]"
              src="../../../public/productSingle/Map.png"
              alt=""
            />
          </div>
        </div>
