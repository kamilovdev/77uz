...
<template>
 <div class="  bg-white">
   <div class="flex flex-col justify-center   containerMain gap-6 max-sm:items-start max-sm:px-5 mt-28 ">
     ...
     <div class="flex bg-white w-[580px] mx-auto justify-center items-center px-5 rounded-lg max-sm:w-[335px] shadow-lg focus-within:shadow-[0px_8.83px_35.31px_0px_#388FF370] transition-all"
       ...
       <input type="text" name="" id="" class="w-[473px] h-[66px] max-sm:w-[170px] focus:outline-none"
     ...
     <div class="text-center">
       ...
       <p class="font-normal text-[16px] text-[#8E9297]">Вы можете найти все категории, которые вам нужны от покупателя</p>
     </div>
